...
const VisualBreak = () => {
  return (
    <section className="relative h-64 md:h-96 lg:h-[32rem] overflow-hidden">
      <div className="absolute inset-0">
        <img 
          src={torresDelPaine} 
          alt="Torres del Paine Mountains" 
      ...
      <div className="relative h-full flex items-center justify-center px-4">
        <div className="text-center max-w-4xl mx-auto">
          <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold text-primary mb-4 animate-fade-in">
